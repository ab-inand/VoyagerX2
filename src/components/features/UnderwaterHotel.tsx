    ...
    <section ref={containerRef} className="relative min-h-screen bg-black py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.button
          ...
          className="mt-8 mx-auto block px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
        >
          Dive into 360° View
        </motion.button>
