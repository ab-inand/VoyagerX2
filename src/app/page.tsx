...
export default function HomePage() {
  ...
  useEffect(() => {
    // Simulate loading time for 3D globe and multiple components
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto text-center">
          ...
          >
            <span className="relative inline-block bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 animate-hologram">
              Journey Beyond Earth: The Future Starts Here
            </span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            Pre-book experiences that redefine travel—from space hotels to hyperloop voyages.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Link href="/future-journey">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="relative px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden"
              >
                <span className="relative z-10">Explore Future Travel</span>
                {/* Neon glow effect */}
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-black to-gray-900 ready-to-start-section">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-16">
                ...
                >
                  We're revolutionizing travel with cutting-edge technology and personalized experiences. Our mission is to make extraordinary journeys accessible to everyone.
                </motion.p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-blue-500/20 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform duration-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                    </div>
                    <h3 className="text-2xl font-bold mb-4 text-white">Innovation First</h3>
                    <p className="text-gray-300 mb-6">Leading the future of travel with AI and blockchain technology, creating seamless experiences for modern explorers.</p>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-purple-500/20 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform duration-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <h3 className="text-2xl font-bold mb-4 text-white">24/7 Support</h3>
                    <p className="text-gray-300 mb-6">Our dedicated team is always ready to assist you, ensuring a smooth journey from planning to return.</p>
                ...
                <motion.div
                  ...
                  className="glass rounded-2xl p-8 relative overflow-hidden group"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-red-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-pink-500/20 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-white">Passion for Travel</h3>
                    <p className="text-gray-300 mb-6">Created by travelers, for travelers. We understand what makes a journey truly memorable.</p>
